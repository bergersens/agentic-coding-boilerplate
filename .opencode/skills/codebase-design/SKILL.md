...
description: Shared vocabulary for designing deep modules. Use when the user wants to design or improve a module's interface, find deepening opportunities, decide where a seam goes, or make code more testable. Also invoked automatically by /improve-arch and /to-prd when architectural decisions come up.
---
